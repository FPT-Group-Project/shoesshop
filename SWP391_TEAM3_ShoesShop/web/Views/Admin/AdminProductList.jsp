                                        ...
                                        <table class="table app-table-hover mb-0 text-left">
                                            ...
                                            <tbody>
                                                <c:forEach var="product" items="${product}">
                                                    <tr>
                                                        <td class="cell">${product.getProductID()}</td>
                                                        <td class="cell"><span class="truncate">${product.getProductName()}</span></td>
                                        ...
                                        <table class="table app-table-hover mb-0 text-left">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="cell">Description</th> <!-- Added description column -->
                                                    <th class="cell">Quantity</th>
                                                    <th class="cell">Price</th>
                                                    <th class="cell">Category</th>
                                                    <th class="cell">Image</th>
                                            ...
                                            <tbody>
                                                <c:if test="${not empty productList}">
                                                    <c:forEach var="product" items="${productList}">
                                                        <tr>
                                                            ...
                                                            <td>$${product.price}</td>
                                                            <td>${product.brandID.brandName}</td> <!-- Assuming brandID refers to the Brand model -->
                                                            <td>
                                                                <img src="${product.avatarP}" alt="${product.productName}" style="width: 50px; height: 50px;" />
                                                            </td>
                                                            <td>
                                                                <a class="btn-sm app-btn-danger" href="deleteProduct?id=${product.productID}" onclick="return confirm('Are you sure you want to delete this product?');">Delete</a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </c:if>
                                                <c:if test="${empty productList}">
                                                    <tr>
                                                        <td colspan="8" class="cell">No products found.</td>
                                                    </tr>
                                                </c:if>
                                            </tbody>
                                        </table>
