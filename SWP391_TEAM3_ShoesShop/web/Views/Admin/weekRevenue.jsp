<%-- 
    ...
    Created on : Nov 7, 2024, 9:09:03 AM
    Author     : vh69
--%>
                            ...
                            <li class="nav-item has-submenu">
                                ...
                                <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                                    <ul class="submenu-list list-unstyled">
                                        ...
                                        <li class="submenu-item"><a class="submenu-link active" href="WeekRevenue">Week revenue</a></li>
                                        <li class="submenu-item"><a class="submenu-link" href="MonthMoney">Month quantity</a></li>
                                        <li class="submenu-item"><a class="submenu-link" href="WeekMoney">Week quantity</a></li>
                                    </ul>
                                </div>
                            </li><!--//nav-item-->
                            <li class="nav-item">
