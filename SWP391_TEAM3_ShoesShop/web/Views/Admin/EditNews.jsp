...
<body class="app">   	
    ...
    <div class="app-wrapper">
        ...
        <div class="mb-3">
            <label for="setting-input-1" class="form-label">Title Name<span class="ms-2" data-bs-container="body" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-placement="top" data-bs-content="This is brand's old name unedited.">
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-info-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                    <path d="M8.93 6.588l-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588z"/>
                    <circle cx="8" cy="4.5" r="1"/>
                </svg></span></label>
            <input type="text" class="form-control" id="setting-input-1" value="${newDetail.title}" required >
            
        </div>
            
            <div class="mb-3">
    <label for="setting-input-1" class="form-label">Content</label>
    <textarea class="form-control"  rows="4" >${contentString}</textarea>
</div>
 <div class="mb-3">
            <label for="setting-input-1" class="form-label">Author:<span class="ms-2" data-bs-container="body" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-placement="top" data-bs-content="This is brand's old name unedited.">
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-info-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                    <path d="M8.93 6.588l-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588z"/>
                    <circle cx="8" cy="4.5" r="1"/>
                </svg></span></label>
            <input type="text" class="form-control" id="setting-input-1" value="${newDetail.author}" required readonly>
            
        </div>
            <div class="mb-3">
            <label for="setting-input-1" class="form-label">Link video:<span class="ms-2" data-bs-container="body" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-placement="top" datvideoa-bs-content="This is brand's old name unedited.">
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-info-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                    <path d="M8.93 6.588l-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588z"/>
                    <circle cx="8" cy="4.5" r="1"/>
                </svg></span></label>
            <input type="text" class="form-control" id="setting-input-1" value="${newDetail.videoLink}" required readonly>
            
        </div>
            <div class="mb-3">
            <label for="setting-input-1" class="form-label">Link product:<span class="ms-2" data-bs-container="body" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-placement="top" data-bs-content="This is brand's old name unedited.">
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-info-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                    <path d="M8.93 6.588l-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588z"/>
                    <circle cx="8" cy="4.5" r="1"/>
                </svg></span></label>
            <input type="text" class="form-control" id="setting-input-1" value="${newDetail.productLink}" required readonly>
            
        </div>

        
<div class="col-md-3">
    <label for="setting-input-1" class="form-label">Image product:<span class="ms-2" data-bs-container="body" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-placement="top" data-bs-content="This is brand's old name unedited.">
                </span></label>
                        <img src="${pageContext.request.contextPath}/ImageNews/${newDetail.image}" alt="${topNews.title}" style="width: 100%; height: auto;" />
                    </div>
...
<!--//app-card-body-->
   ...
   <form class="settings-form" action="EditNews?id=${newDetail.newsID}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        <label for="setting-input-video" class="form-label">Link video11:</label>
