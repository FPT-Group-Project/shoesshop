...
<div class="container">
        ...
        <div class="row">
            <div class="col-md-9 mb-4">
                <p class="lead text-end">Author: ${newDetail.author}</p>


<fmt:formatDate value="${newDetail.uploadDate}" pattern="dd/MM/yyyy" var="formattedDate" />
<p class="lead ">Date upload: ${formattedDate}</p>
