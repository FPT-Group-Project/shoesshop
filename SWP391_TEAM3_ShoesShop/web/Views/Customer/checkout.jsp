...
<form method="post" action="checkout" class="colorlib-form">
    <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="email" name="email" class="form-control" disabled value="${email}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="phone">Phone Number</label>
                        <input type="text" id="phone" name="phone" class="form-control" disabled value="${phone}">
                    </div>
                </div>
            </div>
        </div>

        <!-- Bên phải: Giỏ hàng và phương thức thanh toán -->
        <div class="col-lg-4">
            ...
            <div class="cart-detail">
                ...
                <div class="form-group">
                    <div class="radio">
                        <label><input type="radio" name="optradio" value="bank"> Direct Bank Transfer</label>
                    </div>
                </div>
                <div class="form-group">
                    <div class="radio">
                ...
                <div class="form-group">
                    <div class="checkbox">
                        <label><input type="checkbox" value="" id="rule" name="rule"> I have read and accept the terms and conditions</label><br>
                    </div>
                </div>
            </div>
