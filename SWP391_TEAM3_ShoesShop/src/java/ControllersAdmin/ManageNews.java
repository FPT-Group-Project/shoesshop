...
newsList = dao.getNewsList(page, keyW);
            totalAcc = dao.countNewsByKey(keyW);

        } else {
newsList = dao.getNewsList(page);
 totalAcc = dao.getTotalNewsCount();
        }
    ...
    request.getRequestDispatcher("/Views/Admin/ListNews.jsp").forward(request, response);    } 
