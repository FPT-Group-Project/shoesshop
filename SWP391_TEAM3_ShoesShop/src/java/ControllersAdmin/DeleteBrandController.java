...
public class DeleteBrandController extends HttpServlet {
    ...
    throws ServletException, IOException {
       String idStr = request.getParameter("id");
        ...
        listProductAdmin.deleteBrandById(brandID);

        request.setAttribute("message", "The brand has been successfully deleted.");

        request.getRequestDispatcher("BrandController").forward(request, response);  
    } 
